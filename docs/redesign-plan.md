...
**Yan bulgu (aksiyon alınmadı, kullanıcıya bildirilecek):** Hem `bahrain` hem `jeddah` circuit sayfalarında sırasıyla "Bahrain Grand Prix" (12 Nisan 2026) ve "Saudi Arabian Grand Prix" (19 Nisan 2026) hâlâ "Yaklaşan" olarak görünüyor (round rozeti yok, round≥900 test kaydı gibi duruyor) — ama gerçek 2026 takviminde bu iki GP iptal edildi / Sepang'a taşındı. Bu, circuit-data.ts'deki statik verilerle ilgisiz, senkronize edilen takvim verisinin (Jolpica/Ergast kaynağı) kendisiyle ilgili ayrı bir olası tutarsızlık — henüz araştırılmadı.
