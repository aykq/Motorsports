...
export const SERIES_LIST: SeriesConfig[] = [
  ...
  { slug: "motogp", name: "MotoGP", shortName: "MotoGP", color: "#f97316", available: true, logo: "/series/motogp.svg", subSeries: ["moto2", "moto3"], imageZoom: 1.5 },
  { slug: "moto2", name: "Moto2", shortName: "Moto2", color: "#fb923c", available: true, logo: "/series/moto2.svg", hidden: true, imageZoom: 1.5 },
  { slug: "moto3", name: "Moto3", shortName: "Moto3", color: "#fbbf24", available: true, logo: "/series/moto3.svg", hidden: true, imageZoom: 1.5 },
