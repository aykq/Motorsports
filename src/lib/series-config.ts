...
export const SERIES_LIST: SeriesConfig[] = [
  { slug: "f1", name: "Formula 1", shortName: "F1", color: "#e11d48", available: true, logo: "/series/f1.svg", imageObjectPosition: "center -5%" },
  { slug: "wec", name: "FIA WEC / Le Mans", shortName: "WEC", color: "#0ea5e9", available: true, logo: "/series/wec.svg" },
  { slug: "motogp", name: "MotoGP", shortName: "MotoGP", color: "#f97316", available: true, logo: "/series/motogp.svg", subSeries: ["moto2", "moto3"], imageObjectPosition: "center top" },
  { slug: "moto2", name: "Moto2", shortName: "Moto2", color: "#fb923c", available: true, logo: "/series/moto2.svg", hidden: true, imageObjectPosition: "center top" },
  { slug: "moto3", name: "Moto3", shortName: "Moto3", color: "#fbbf24", available: true, logo: "/series/moto3.svg", hidden: true, imageObjectPosition: "center top" },
