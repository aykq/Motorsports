...
// slug degerleri motogp-api.ts'teki teamSlug() fonksiyonuyla olusturulan Driver.teamId ile eslesmeli.
// Renkler MotoGP API'sinin color alanindan alinmistir (2026 sezonu).
// logo: takimin motosiklet fotografidir (photos.motogp.com CDN, next.config.ts'te whitelist'te).
