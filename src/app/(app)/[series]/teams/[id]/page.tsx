        ...
        {standing && (
          <div className="grid grid-cols-3 gap-3">
            <div className="rounded-lg bg-card border border-border p-3 text-center">
              ...
              <p className="font-display text-[10px] text-muted-foreground tracking-wide mt-0.5">{t("ranking")}</p>
            </div>
            <div className="rounded-lg bg-card border border-border p-3 text-center">
              <p className="font-mono text-2xl font-bold tabular-nums">{standing.points}</p>
              <p className="font-display text-[10px] text-muted-foreground tracking-wide mt-0.5">{t("points")}</p>
            </div>
            <div className="rounded-lg bg-card border border-border p-3 text-center">
              <p className="font-mono text-2xl font-bold tabular-nums">{standing.wins}</p>
              <p className="font-display text-[10px] text-muted-foreground tracking-wide mt-0.5">{t("wins")}</p>
            </div>
          </div>
        )}
